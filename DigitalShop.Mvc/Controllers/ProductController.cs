...
using DigitalShop.Models.Models.ViewModels;
...
public class ProductController : Controller
{
    ...
    public IActionResult Upsert(int? id)
    {
        ProductVM productVM = new ProductVM()
        {
            ...
            ApplicationTypeSelectList = _context.ApplicationTypes.Select(c => new SelectListItem
            {
                Text = c.Name,
                Value = c.Id.ToString(),
            })
    ...
    public IActionResult Upsert(ProductVM productVM)
    {
        ...
        productVM.ApplicationTypeSelectList = _context.ApplicationTypes.Select(c => new SelectListItem
        {
            Text = c.Name,
            Value = c.Id.ToString(),
        });
    ...
    public IActionResult Delete(int? id)
    {
        ...
        Product product = _context.Products.Include(p => p.Category).Include(p => p.ApplicationType).FirstOrDefault(p => p.Id == id);
